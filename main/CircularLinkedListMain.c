...
int main() {
        ...
        do {
                ...
                switch(ch) {
                        case 1 : printf("Enter the key to add to the beginning : ");
                                 scanf("%d", &x);
                                 insertAtBeg(&head, x);
                                 printf("Successfully added element!\n");
                                 break;

                        case 2 : printf("Enter the key to add to the end : ");
                                 scanf("%d", &x);
                                 insertAtEnd(&head, x);
                                 printf("Successfully added element!\n");
                                 break;

                        case 3 : printf("Enter the key to add : ");
                                 scanf("%d", &x);
                                 printf("Enter the position to add the element : ");
                                 scanf("%d", &index);
                                 ret = insertAtPos(&head, x, index);
                                 if(ret == INT_MIN) printf("Could not add element to the list!\n");
                        ...
                        case 4 : printf("Enter key to delete : ");
                                 ...
                                 if(ret == INT_MIN) printf("Key not found!\n");
                                 else printf("Key deleted!\n");
                                 break;

                        case 5 : printf("Enter index to delete : ");
                                 scanf("%d", &index);
                                 ret = deleteIndex(&head, index);
                                 if(ret == INT_MAX) printf("Index deleted!\n");
                        ...
                        case 8 : printf("Enter index to search for : ");
                                 scanf("%d", &index);
                        ...
                        case 13 : if(printList(head) == INT_MIN) printf("No elements to print!\n");
                                          break;
